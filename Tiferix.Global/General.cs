...
namespace Tiferix.Global
{
   #region Global Enumerations
    ...
    /// <summary>
    /// A set of shapes used for the display of various DotCool controls.
    /// </summary>
    public enum CoolShape
    {
        Circle = 1,
        Square = 2,
        Rectangle = 3,
    ...
    /// <summary>
    /// Indicates how images displayed in various DotCool controls will be sized.
    /// </summary>
    public enum CoolImageSizeMode
    {
        Normal = 0,
        StretchImage = 1,
        CenterImage = 2,
    ...
    /// <summary>
    /// Static class that handles a variety of general tasks and operations, as well as provides a large set of utility functions that can be used by 
    /// various Tiferix software libraries.
    /// </summary>
    public static class General
    {
        ...
        */
        ...
        static General()
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in Constructor function of General class.");
            }
            finally
            {
                if (stream != null)
        ...
        public static string ApplicationPath
        {
            get
            {
                ...
                if (strAppPath.EndsWith("\\bin\\Debug"))
                {
        ...
        public static string TempFilesPath
        {
            get
            {
                return General.ApplicationPath + @"\TempFiles";
            }
        }
...
#region Memory/Stream Related Properties, Functions
        ...
        public static byte[] SerializeObject(object data/*, bool blEncryptData = false*/)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in SerializeObject function of General class.");
                return null;
            }
        }
        ...
        public static object DeserializeObject(byte[] bufData/*, bool blDecryptData = false*/)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in DeserializeObject Overload 1 function of General class.");
                return null;
            }
            finally
            {
        ...
        public static ObjType DeserializeObject<ObjType>(byte[] bufData)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in DeserializeObject Overload 2 function of General class.");
...
#region File Related Properties, Functions
        ...
        /// <summary>
        /// Saves a binary buffer to a file on disk with the full path and name specified in the function's FileName parameter.  Any existing file with the same name
        /// will be overwritten.
        /// </summary>
        ...
        public static void SaveBufferToFile(string strFileName, byte[] bufData, int iOffset, int iCount/*, bool blEncryptData = false*/)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in SaveBufferToFile Overload 1 function of General class.");
            }
            finally
            {
                if (fstream != null)
        ...
        public static void SaveBufferToFile(string strFileName, byte[] bufData/*, bool blEncryptData = false*/)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in SaveBufferToFile Overload 2 function of General class.");
            }
        }
        ...
        public static string GenerateTempFileName(string strFileExt = "TMP", int iGuidLen = 8)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in GenerateTempFileName function of General class.");
                return "";
            }
        }
        ...
        public static string CreateTempFile(byte[] bufFileData, string strFileExt = "TMP", int iGuidLen = 8, string strTempFilePath = "")
        {
            ...
            try
            {
                ...
                if (strTempFilePath == "")
                    strTempFilePath = General.TempFilesPath;
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in CreateTempFile Overload 1 function of General class.");
                return "";
            }
            finally
            {
        ...
        public static string CreateTempFile(string strFileName, int iGuidLen = 8, string strTempFilePath = "")
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in CreateTempFile Overload 2 function of General class.");
                return "";
            }
        }
        ...
        public static string GenerateFileName(byte bType, string strPrefix = "", string strFileExt = "TMP", int iGuidLen = 7)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in GenerateFileName function of General class.");
                return "";
            }
        }
        ...
        public static long GetDirSize(string strDirectory, string strSearchPattern = "", bool blSupressErrMsg = false)
        {
            ...
            {
                if (!blSupressErrMsg)
                    ErrorHandler.ShowErrorMessage(err, "Error in GetDirSize function of General class.");
...
#region Global Information Functions
        ...
        public static string GetAppVersion()
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in GetAppVersion function of General class.");
                return "";
            }
        }
        ...
        public static string MacAddress(bool blFormatted = false)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in MacAddress function of General class.");
                return "";
            }
        }
...
#region Global Color-Related Functions
        ...
        public static string ToHexRGBColor(Color color)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in ToHexColor function of General class.");
                return "";
            }
        }
...
#region Global Process Related Functions
        ...
        public static bool CheckExistingProcess(string strProcName)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in CheckExistingProcess function of General class.");
...
#region ADO.NET Extension Properties, Functions
        ...
        public static object GetADOValue(object oValue, OleDbType dataType)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in GetADOValue function of General class.");
                return null;
            }
        }
        ...
        public static void CloseADODataObject(DbConnection connObj)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in CloseADODataObject Overload 1 function of General class.");
            }
        }
        ...
        public static void CloseADODataObject(DbCommand cmdObj)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in CloseADODataObject Overload 2 function of General class.");
            }
        }
        ...
        public static void CloseADODataObject(DbDataReader drdObj)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in CloseADODataObject Overload 3 function of General class.");
            }
        }
...
#region Form Focus Functions/Event Handlers
        ...
        /// in the General class will be used during Form_Load events, since a problem seems to occur when setting the focus to a control
        ...
        public static void SetFocus(Control ctrl)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in SetFocus function of General class.");
            }
        }
        ...
        private static void FocusTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in FocusTimer_Tick event handler of General class.");
            }
        }
...
#region .NET GDI+ Imaging Properties, Functions
        ...
        public static byte[] SaveBitmapToJPEG(Bitmap bmpImage, int iQuality)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in SaveBitmapToJPEG Overload 1 function of General class.");
                return null;
            }
            finally
            {
        ...
        public static void SaveBitmapToJPEG(string strFileName, Bitmap bmpImage, int iQuality)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in SaveBitmapToJPEG Overload 2 function of General class.");
            }
            finally
            {
                if (fs != null)
        ...
        public static ImageCodecInfo GetGDIEncoder(ImageFormat format)
        {
            ...
            {
                ErrorHandler.ShowErrorMessage(err, "Error in GetGDIEncoder function of General class.");
                return null;
            }
        }
        ...
        /* NOT USED: Disabled to prevent circular dependencies
